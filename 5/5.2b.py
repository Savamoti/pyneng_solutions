...
parameter_name = input('Enter parameter name (ios,model,vendor,location,ip):')

print(london_co[device_name][parameter_name])

"""
./5.2b.py 
Enter device name(r1/r2/sw1):r1
Enter parameter name (ios,model,vendor,location,ip)):model
4451
"""
